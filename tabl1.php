    ...
    <div class="row">
      <div class="col-sm-12">
        <form action="" method="post" class="table-col">
          ...
          <input type="date" id="StartDate" class="datepicker setNext hasDatepicker" name="StartDate" style="margin-right:10px;">
          <label for="">End Date: &nbsp;</label>
          <input type="date" id="EndDate" class="datepicker hasDatepicker" name="EndDate" style="margin-right:10px;">
...
<hr>
        ...
        <table cellspacing="0" cellpadding="0" class="table_data" id="emp-data" border="">
          <thead>
            ...
            <tr>
              ...
              // select DATE_FORMAT(todays_date,'%d') from attendance;
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        //SELECT count(id) FROM attendance where id = 1 and WEEKDAY(todays_date)<>6 and time_in = 0;
        $row = mysqli_query($conn, $queryA);
        ?>
        <?php
        while ($data = mysqli_fetch_array($row)) {
